...
namespace ProProfile.Controllers
{
    public class HomeController : Controller
    {
        private ProProfileContext _context;

        public HomeController(ProProfileContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public IActionResult Dashboard()
        {
            ...
            Users user = _context.Users.Include(u => u.Friends).Where(x => x.idUser == CurrentUser).SingleOrDefault();
